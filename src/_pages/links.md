...
<div class="button button--primary" style="width: 100%; display: flex; align-items: center; padding: 0; height: 3.5rem; position: relative;" onclick="window.open('https://maya.cloud/monolith', '_blank')">
...
<div class="button button--primary" style="width: 100%; display: flex; align-items: center; padding: 0; height: 3.5rem; position: relative;" onclick="window.open('https://maya.cloud/paralysis', '_blank')">
  <div class="button-image" style="height: 100%; margin: 0; padding: 0; position: absolute; left: 0;">
