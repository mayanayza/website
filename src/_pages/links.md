...
<h2>Featured</h2>
<div class="button button--primary" style="width: 100%; display: flex; justify-content: center; text-align: center;" onclick="window.open('http://mayaferrandiz.com/paralysis', '_blank')">
    Paralysis
</div>
<br />
<h2>Links</h2>
