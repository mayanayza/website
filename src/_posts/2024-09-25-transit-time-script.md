...
description: Automatic calendar blocking while you're going to be in-transit
date: 2024-09-25
tags:
- Automation
featured: false
...
---
  [View on GitHub](https://github.com/mayaferrandiz/transit-time-script){:target="_blank"}
