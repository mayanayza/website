...
written_content: Paralysis is a kinetic sculpture which represents the artist's journey
  ...
  viewer. As the user is drawn in by the delicacy and organic motion of this mechanism,
  an LED display scrolls messages representing the artist's mental state over the
  decade of repression, communicating the depths of the journey which led to the piece's
  ultimate creation.
readme: ''
