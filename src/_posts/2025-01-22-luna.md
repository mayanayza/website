...
layout: post
title: Luna
description: A content syndication tool for artists and creative technologists
date: 2025-01-22
tags:
- Automation
featured: false
featured_code: "            'config': config\n        }\n            \n        super().__init__(**init)\n\
  ...
  Failed to publish website: {e}\")\n"
code_language: python
---
  [View on GitHub](https://github.com/mayaferrandiz/luna){:target="_blank"}
